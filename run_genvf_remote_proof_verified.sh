...
python -m pipelinerl.launch \
  --config-name=genvf_v8_proof_verified \
  output_dir="/project/flame/aviralku/results/genvf-v8-proof-verified-20260411-215733" \
...
# output_dir="/project/flame/aviralku/results/genvf-v8-proof-verified-${timestamp}" \
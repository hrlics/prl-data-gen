export OPENAI_BASE_URL=http://10.16.0.116:8000/v1
...
timestamp=$(date +'%Y%m%d-%H%M%S'); python -m pipelinerl.launch --config-name=genvf_v4_summarized_summary output_dir="/project/flame/aviralku/results/genvf_v4_summarized_summary-${timestamp}"